...
2. **bounded** **`event_ranges` **— **a** ** **non-** ** **empty** ** **JSON** ** **array** ** **of** ** **per-** **`actor`** ** **inclusive** ** **ranges** ** **in** ** **per-** **actor** ** **log** ** **order** **( ** **§0.6.1** **) ** **defining** ** **a** ** **finite** ** **window** ** **per** ** **`actor` **;** **or**
...
**Cross-** **`actor` ** **ordering** ** **( ** **normative** ** **for** ** **applicable** **`reduce` ** **ids** **) **: ** A ** **reducer** ** **that** ** **merges** ** **or** ** **totally** ** **orders** ** **items** ** **from** ** **more** ** **than** ** **one** **`actor`** ** **( ** **or** ** **from** ** **more** ** **than** ** **one** **`event_ranges` ** **element** **) ** **MUST** ** **define** ** **in** ** **its** ** **§17.10** ** **/** ** **registry** ** **specification** ** **a** ** **deterministic** ** **cross-** **`actor` ** **total** ** **order** ** **( ** **e.g. ** **`(ts, event_id)`** ** **lexicographic** ** **as** ** **in** ** **§17.10** ** **chronological** ** **reducer** **, ** **or** ** **another** ** **documented** ** **tie-** ** **break** **) **. ** **Per-** **`actor` **`event_ranges` ** **remain** ** **in** ** **that** **`actor`’s** ** **log** ** **order** **; ** **the** ** **cross-** **`actor` ** **rule** ** **applies** ** **when** ** **the** **`reduce` ** **combines** ** **those** ** **streams** **. **
...
**Reducer input domains (normative):** Every **`reduce`** **identifier** **( ** **including** ** **§17.10** ** **core** ** **ids** **) ** **MUST** ** **have** ** **a** ** **machine-** ** **readable** ** **specification** ** **that** ** **lists** ** **which** ** **input** ** **domains** ** **it** ** **reads** ** **( ** **e.g. ** **actor** ** **log** ** **events** **, ** **state** ** **objects** **, **`relay.snapshot.v1`** ** **membership** **, ** **channel** ** **expansions** **, ** **nested** ** **feeds** **) ** **and** ** **which** ** **Boundary** ** **fields** ** **from** ** **§0.6** ** **( **`snapshot`**, **`event_ranges`**, **`state_scope`**, ** **combinations** **) ** **are** ** **required** ** **to** ** **make** ** **those** ** **inputs** ** **finite** ** **and** ** **unambiguous** **. ** **Core** ** **reducers** ** **in** ** **this** ** **section** ** **satisfy** ** **that** ** **by** ** **definition** **; ** **extensions** ** **MUST** ** **do** ** **so** ** **in** **`registry/`** ** **( ** **§22** **) ** **or** ** **the** ** **cited** ** **extension** ** **document** **. ** **The** ** **intent** ** **is** ** **static** ** **validation** ** **,** ** **tooling** **, ** **and** ** **safe** ** **execution** ** **without** ** **inspecting** ** **opaque** ** **code** **. **

**Additional reducers:** **MUST** **be** **registered** **with** ** **those** ** **input** ** **domains** **, ** **`params`**, ** **types** **, ** **and** ** **merge** ** **semantics** ** **in** **`registry/`** ** **and/or** ** **cited** ** **from** ** **extension** ** **documents** **( ** **§22** **) **. ** **MUST** ** **be** ** **deterministic** ** **and** ** **versioned** **; ** **MUST** ** **not** ** **require** ** **out-** ** **of-** ** **band** ** **mutable** ** **global** ** **state** ** **as** ** **a** ** **MUST** ** **in** ** **core** ** **( ** **only** ** **fetched** ** **signed** ** **artifacts** ** **and** **`params` ** **bytes** ** **in** ** **the** ** **definition** ** **state** **) **. **
